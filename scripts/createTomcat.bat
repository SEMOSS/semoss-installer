...
if exist "%server_settings%" (
    ...
    echo File does not exist: %server_settings%
        ...
        (
            ...
            echo runtimes=^<?xml version\="1.0" encoding\="UTF-8" standalone\="no"?^>\r\n^<runtimes^>\r\n  ^<runtime id\="Apache Tomcat v9.0" location\="%workspacePath%/%Tomcat_Version%" name\="Apache Tomcat v9.0" runtime-type-id\="org.eclipse.jst.server.tomcat.runtime.90" timestamp\="0"/^>\r\n^</runtimes^>\r\n
        ) > "%server_settings%"
